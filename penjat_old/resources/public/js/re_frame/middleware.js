...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__24918){
...
return cljs.core.get_in.call(null,new_db,p1__24919_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__24920_SHARP_){
return cljs.core.get_in.call(null,db,p1__24920_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__24921__i < G__24921__a.length) {G__24921__a[G__24921__i] = arguments[G__24921__i + 2]; ++G__24921__i;}
  in_paths = new cljs.core.IndexedSeq(G__24921__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__24922){
var f = cljs.core.first(arglist__24922);
arglist__24922 = cljs.core.next(arglist__24922);
var out_path = cljs.core.first(arglist__24922);
var in_paths = cljs.core.rest(arglist__24922);
...
//# sourceMappingURL=middleware.js.map?rel=1453792890884