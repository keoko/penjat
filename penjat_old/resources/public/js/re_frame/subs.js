...
var args24844 = [];
var len__17898__auto___24848 = arguments.length;
var i__17899__auto___24849 = (0);
while(true){
if((i__17899__auto___24849 < len__17898__auto___24848)){
args24844.push((arguments[i__17899__auto___24849]));

var G__24850 = (i__17899__auto___24849 + (1));
i__17899__auto___24849 = G__24850;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args24844.length)].join('')));
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4425__auto___24852 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__24843_SHARP_){
if(!((p1__24843_SHARP_ == null))){
if((false) || (p1__24843_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
,dynv));
if(temp__4425__auto___24852){
var not_reactive_24853 = temp__4425__auto___24852;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_24853);
} else {
}
} else {
}
...
//# sourceMappingURL=subs.js.map?rel=1453792890472